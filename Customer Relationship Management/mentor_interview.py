...
class Ui_MentorInterview(object):
    def setupUi(self, MentorInterview):
        ...
        MentorInterview.resize(1024, 860)
        MentorInterview.setMinimumSize(QtCore.QSize(1024, 860))
        MentorInterview.setMaximumSize(QtCore.QSize(1024, 860))
...
"")
        ...
        self.label.setGeometry(QtCore.QRect(-50, 0, 1091, 171))
        font = QtGui.QFont()
...
"}")
        ...
        self.applications_search_line.setGeometry(QtCore.QRect(80, 220, 611, 41))
        ...
        self.interviews_search_button.setGeometry(QtCore.QRect(730, 220, 211, 44))
        ...
        self.pushButton_tumGorusmeler.setGeometry(QtCore.QRect(729, 294, 211, 81))
        font = QtGui.QFont()
        font.setPointSize(-1)
        ...
        self.comboBox_.setGeometry(QtCore.QRect(80, 290, 611, 41))
        font = QtGui.QFont()
        ...
        self.tableWidget_butunGorusmeler.setGeometry(QtCore.QRect(80, 390, 859, 321))
        ...
        self.pushButton_geriDon.setGeometry(QtCore.QRect(80, 750, 371, 51))
        font = QtGui.QFont()
        font.setPointSize(-1)
