...
class Ui_Applications(object):
    def setupUi(self, Applications):
        ...
        Applications.resize(1024, 860)
        Applications.setMinimumSize(QtCore.QSize(1024, 860))
        Applications.setMaximumSize(QtCore.QSize(1024, 860))
...
"")
        ...
        self.applications_search_line.setGeometry(QtCore.QRect(70, 220, 671, 51))
        ...
        self.applications_table.setGeometry(QtCore.QRect(40, 510, 951, 231))
        self.applications_table.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.applications_all_button.setGeometry(QtCore.QRect(690, 300, 261, 91))
        font = QtGui.QFont()
        font.setPointSize(-1)
        ...
        self.applications_defined_button.setGeometry(QtCore.QRect(70, 300, 421, 91))
        font = QtGui.QFont()
        font.setPointSize(-1)
        ...
        self.applications_undefined_button.setGeometry(QtCore.QRect(70, 410, 421, 81))
        font = QtGui.QFont()
        font.setPointSize(-1)
        ...
        self.applications_search_button.setGeometry(QtCore.QRect(760, 220, 191, 51))
        ...
        self.applications_title_label.setGeometry(QtCore.QRect(-30, -20, 1061, 191))
        font = QtGui.QFont()
...
"}")
        ...
        self.pushButton_geriDon.setGeometry(QtCore.QRect(581, 410, 371, 81))
        font = QtGui.QFont()
        font.setPointSize(-1)
